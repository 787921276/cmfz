    ...
    <script>
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${path}/code/getCode?t=" + new Date().getTime());
            });
            $.extend($.validator.messages, {
                required: "<span style='color:blue'>这是必填字段</span>",
            });
            $("#loginButtonId").click(function () {
                var flag = $("#loginForm").valid();
                if (flag) {
                    $.ajax({
                        url: "${path}/Admin/querUsernameAndPwd",
                        type: "post",
                        dataType: "json",
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <span id="mag" style="color: red"></span>
                        </div>
